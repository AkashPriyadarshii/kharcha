...
**Status:** open. Local `flutter test` on a Windows host crashes until Flutter fixes the native-assets bug. Not a code failure — do not "fix" tests to work around it. CI was removed (2026-08-06) — see CLAUDE.md.
